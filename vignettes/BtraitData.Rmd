...
```{r, fig.width=11, fig.height=12, eval = TRUE}
par(mfrow = c(2,2))
...
In the function *get_trait_density*, we pass the value of the modalities (trait_._score) of the trait classes, so that the average modality value will be calculated. 
