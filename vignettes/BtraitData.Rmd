...
require(Btrait)
Rpacks <- c(citation(package="base"), 
  citation(package="plot3D"), 
  citation(package="Btrait"))
```
...
We use function *mapBtrait* to generate figures with station positions, passing the respective contours for each dataset. 
...
Holstein Jan (2018). worms: Retrieving Aphia Information from World Register of
Marine Species. R package version 0.2.2.
